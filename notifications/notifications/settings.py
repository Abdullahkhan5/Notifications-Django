...
SECRET_KEY = "django-insecure-u0k1+q+a67w)01g2ub-y(1upt(f+dttze8(%q167_x_+(&0e=j"
...
# Configure Channels with Redis (you'll need to install and run Redis locally for testing)
CHANNEL_LAYERS = {
    "default": {
